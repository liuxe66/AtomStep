...
public class NumberWheelView extends WheelView {
    ...
    public void setRange(int min, int max, int step,int defaultValue) {
        ...
        super.setData(data,defaultValue);
    }

    public void setRange(float min, float max, float step,float defaultValue) {
